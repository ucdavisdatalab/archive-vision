/* ===============================================================================================
   collect.cpp            Version 1               05/06/2018            Arthur Koehl

   A clone of makeAdjacency but it also appends all the metadata for each match into a csv.
   csv format for data.csv (the output default filename):
      seed.jpg, target.jpg, num keypoints seed, num keypoints target, ratio, symmetry, ransac
      size and response will be collected in processimages.cpp 
   ...
   For example:
	image.jpg, image.jpg 500, image2.jpg 30, image4.jpg 7
   
   All of the other parameters are hard coded and need to be updated and recompiled. Use this  
   one in conjunction with parallel.sh script.
   =============================================================================================== */
...
/* ===============================================================================================
  ...
  nkeypoints1 = keypoints1.size();
  filter_keypoints (keypoints1, sizemin, responsemin);
  postfilter = keypoints1.size();
...
/*      =========================================================================================
    ...
    int nkeypoints2, bruteforcematch, postratio, postsymmetry, postransac;
	  infofile = files[i];
    pos = 0;
...
/* ===============================================================================================
   ...
   =============================================================================================== */
  string txtfile = output + argv[1] + ".txt";
